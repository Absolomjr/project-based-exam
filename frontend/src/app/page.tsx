/**
 * HomePage: Core landing page orchestrator.
 * Fetches and aggregates movie data (trending, theaters, top-rated) using 
 * a resilient concurrent fetching pattern. Manages cinematic layout, 
 * discovery modules, and global loading states.
 */
